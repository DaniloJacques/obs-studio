...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    # Profile-aware dependency resolution
    set(fetch_platform ${platform})
    set(fetch_arch ${arch})
    if(OBS_DEPS_PROFILE AND dependency STREQUAL prebuilt)
      ...
      if(NOT profile_error AND NOT profile_hash STREQUAL "NOTFOUND")
        ...
        message(STATUS "Using optimized profile '${OBS_DEPS_PROFILE}' for ${dependency}")
      endif()
    endif()
    ...
    if(EXISTS "${dependencies_dir}/.dependency_${dependency}_${fetch_arch}.sha256")
      file(
        READ "${dependencies_dir}/.dependency_${dependency}_${fetch_arch}.sha256"
